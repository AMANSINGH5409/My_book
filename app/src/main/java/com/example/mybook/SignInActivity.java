...
import com.example.mybook.databinding.ActivitySignInBinding;
        ...
        binding.btnSignIn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(binding.editTextUserEmailId.getText().toString().isEmpty()){
                    binding.editTextUserEmailId.setError("Enter Your Registered EmailId !");
                    return;
                }
                if (binding.editTextUserPassword.getText().toString().isEmpty()){
                    binding.editTextUserPassword.setError("Enter Your Password !");
                    return;
                }
                progressDialog.show();
                auth.signInWithEmailAndPassword(binding.editTextUserEmailId.getText().toString(),binding.editTextUserPassword.getText().toString())
